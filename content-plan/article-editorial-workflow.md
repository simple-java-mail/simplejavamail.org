...
Check local transitions: why does this sentence or paragraph follow the previous one? Supply the missing connection rather than a generic "Let's see what that looks like."

## Pass 3: Control density and keep useful connective prose
...
- Keep diagrams compact and legible, without unnecessary nested containers or one node per sentence.
